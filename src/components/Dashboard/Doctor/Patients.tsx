  ...
  return (
    <div className='mx-5'>
      ...
      <div className='mt-4 bg-gray-200 p-2 rounded-md'>
        <div className='grid grid-cols-3 gap-2 p-3 font-semibold border-b border-gray-400'>
          <p>Patients</p>
          <p>Phone Number</p>
          <p>Location</p>
        </div>
        <div className='my-2 overflow-y-auto h-[54vh]'>
          {
            sortedData.length > 0 ? (
              sortedData.map((item) => (
                <div key={item._id} className='grid grid-cols-3 gap-2 p-2 rounded-md shadow-sm'>
                  <div>
                    <p>{item.userName}</p>
