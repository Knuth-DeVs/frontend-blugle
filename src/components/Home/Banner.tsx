...
const Banner = () => {
  return (
    <div className='mb-6'>
        <div className='h-[400px] w-full bg-[#70C0E6] mt-60 shadow-lg'>
            <div className='flex flex-row items-center justify-center'>
                <img src={BannerImg} alt='banner' className='w-[380px] pt-3'/>
                <div className='flex flex-col gap-4'>
                    <h1 className='text-6xl font-semibold text-navlinkshover'>Our Solutions</h1>
                    ...
                    <div className='flex items-center justify-evenly text-3xl text-navlinkshover font-semibold'>
                        <div>
