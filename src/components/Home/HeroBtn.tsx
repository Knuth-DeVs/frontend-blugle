...
const HeroBtn = () => {
  return (
    <>
      ...
      <p className='pt-10 text-3xl md:text-5xl md:w-[800px] mx-auto text-center font-medium'>
      ...
      <div className='text-center'>
        ...
        <p className='px-8 md:px-64 text-gray-600 pb-8'>Join a system that helps doctors and nurses provide better care by making it easier to manage patient information, schedule appointments, and communicate with patients.</p>
      </div>
    </div> 
