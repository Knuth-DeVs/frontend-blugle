...
const Main = () => {
  return (
    <div>
        ...
        <div className='flex flex-col-reverse px-8 md:flex-row md:gap-16 md:px-28 md:mt-20'>
            <img src={Vision} alt="vision" className='md:w-[550px] pt-6'/>
            <div>
                <h1 className='text-3xl md:text-5xl text-navlinks font-bold'>Our Vision</h1>
